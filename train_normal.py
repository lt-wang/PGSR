...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    ema_prior_normal_for_log = 0.0  # 法线先验损失的EMA
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        # 单视图损失：法线一致性损失
        opt.single_view_weight_from_iter = 0  # 从第0次迭代开始使用单视图损失
        ...
        if viewpoint_cam.normal is not None :
            ...
            rend_normal = render_pkg["rendered_normal"]    # 渲染的法线
            surf_normal = render_pkg["depth_normal"]   # 从深度计算的法线
            prior_normal = viewpoint_cam.normal.detach()
        ...
        with torch.no_grad():
            ...
            if iteration % 10 == 0:
                loss_dict = {
                    ...
                    "prior": f"{ema_prior_normal_for_log:.{5}f}",
